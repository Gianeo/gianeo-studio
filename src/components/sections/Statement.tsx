    ...
    <section className="bg-background text-foreground py-20 lg:py-24">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-6 lg:px-0 flex flex-col gap-4">
          <p className="text-[11px] font-mono uppercase tracking-[0.5em] text-muted-foreground">
            Experience
          </p>
          <p
            className={clsx(
              "font-heading heading-tight text-3xl sm:text-4xl lg:text-[2.6rem]",
              "text-foreground/80 leading-tight max-w-4xl"
            )}
          >
